...
namespace ChallengeThree_Console
{
    class ProgramUI
    {
        ...
        private void GetAllBadges()
        {
            ...
            //Dictionary<int, BadgeContent> keyValuePairs = _badgeRepo.GetDictList();
            ...
            //foreach (KeyValuePair<int, List<string>> kvp in _dic)
            //{
            //    foreach (string value in kvp.Value)
            //    {
            //        Console.WriteLine("{0,-10}, {1,-30}", kvp.Key, value);
            //    }
            //}
