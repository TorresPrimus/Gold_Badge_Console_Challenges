...
namespace ChallengeTwo_Console
{
    ...
    public class ProgramUI
    {
        ...
        {
            Console.Clear();
            // show details of first claim in queue
            ...
            // if y remove item from queue if n return to main menu
            if (userInput == "y")
            {
        ...
        private void AddNewClaim()
        {
            ...
            //Queue<ClaimContent> count = _claimRepo.GetClaimContents();
            //int a = count.Count;
            //a++;
            //newClaim.ClaimID = a;
        ...
        private void DefaultClaims()
        {
            ...
            ClaimContent ruudberg = new ClaimContent(3, TypesOfClaims.Theft, "Stolen pancakes.", 4, new DateTime(2018, 4, 27), new DateTime(2018, 6, 01), false);
