...
namespace Challenge_One_Tests
{
    ...
    public class CafeRepoTest
    {
        ...
        {
            CafeContent newContent = new CafeContent(1,"Ham and Cheese", "Twenty slices of ham and five slices of melted cheese between two slices of french bread.", _listOfIngredients, 12.99);
